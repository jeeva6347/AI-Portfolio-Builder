    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('ADMIN', 'Admin'), ('PREMIUM_USER', 'Premium User'), ('FREE_USER', 'Free User')], default='FREE_USER', help_text='Determines dashboard access and permission scope.', max_length=20)),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avatars/')),
                ('github_username', models.CharField(blank=True, default='', max_length=150)),
